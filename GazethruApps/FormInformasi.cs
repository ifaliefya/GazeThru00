...
namespace GazethruApps
{
    public partial class formInformasi : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            progressBarTntg.Location = new Point((int)wx[0], (int)wy[0]);
            progressBarKgtn.Location = new Point((int)wx[1], (int)wy[1]);
            progressBarPrst.Location = new Point((int)wx[2], (int)wy[2]);
        ...
        private void KgtnTekan(ArgumenKendaliTombol e)
        {
            ...
            progressBarKgtn.Value = e.DataKor;
        }
        ...
        private void PrestasiTekan(ArgumenKendaliTombol e)
        {
            ...
            progressBarPrst.Value = e.DataKor;
        }
        ...
        private void TentangTekan(ArgumenKendaliTombol e)
        {
            ...
            progressBarTntg.Value = e.DataKor;
        }
